            ...
            <div class="box-body pad">
              <form action="" id="form">
                <div class="form-group">
                  ...
                  <input type="text" name="title" id="title" class="form-control" placeholder="Title Article">
                </div>
                <div class="form-group">
                  <label>Editor</label>
                  <textarea name="mainArticle" id="mainArticle" class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                </div>
...
<script>
  ...
  function save(){
    $.ajax({
      url: '<?php echo base_url("index.php/Article/ajax_add")?>',
      method: 'POST',
      data: $('#form').serialize(),
      dataType: 'json',
      async: false,
      success: function(data){
        $('.alert-success').html('Successfully Add Article').fadeIn().delay(4000).fadeOut('slow');
      },
