...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="../../index2.html" class="logo" style="background-color: #ff5722;">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b style="font-family: tahoma;">K</b>ibu</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b style="font-family: tahoma;">Khas</b>Ibu</span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top" style="background-color: #f97950;">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header" style="background-color: #f97950;">
                <img src="<?php echo base_url('assets/img/user2-160x160.jpg');?>" class="img-circle" alt="User Image">

                <p>
                  <?php echo $this->session->userdata['id'];?> - Admin
                  <small>Toko Khas Ibu - 2019</small>
                </p>
              </li>
              <!-- Menu Footer-->
          ...
          <!-- Control Sidebar Toggle Button here-->
        </ul>
      </div>
    </nav>
  </header>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url('index.php/Message/show_notif');?>"><i class="fa fa-circle-o text-aqua"></i> Messages</a></li>
            <li><a href="#"><i class="fa fa-circle-o text-red"></i> Sales</a></li>
          </ul>
        </li>
        <li>
